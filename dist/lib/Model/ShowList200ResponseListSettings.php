<?php
/**
 * ShowList200ResponseListSettings
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ShowList200ResponseListSettings Class Doc Comment
 *
 * @category Class
 * @package  StejskyTom\Ecomail
 * @author   OpenAPI Generator team
 ...
 */
class ShowList200ResponseListSettings implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Show_list_200_response_list_settings';
    ...
    protected static $openAPITypes = [
        'webhook' => '\StejskyTom\Ecomail\Model\ShowList200ResponseListSettingsWebhook',
        'secured_forms' => 'bool'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('secured_forms', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets webhook
     *
     * @return \StejskyTom\Ecomail\Model\ShowList200ResponseListSettingsWebhook|null
     */
     ...
     * Sets webhook
     *
     * @param \StejskyTom\Ecomail\Model\ShowList200ResponseListSettingsWebhook|null $webhook webhook
     *
     * @return self
     */
     ...
     * @return bool|null
     */
    public function getSecuredForms()
    {
        return $this->container['secured_forms'];
    }

    /**
     * Sets secured_forms
     *
     * @param bool|null $secured_forms secured_forms
     *
     * @return self
     */
    public function setSecuredForms($secured_forms)
    {
        if (is_null($secured_forms)) {
            throw new \InvalidArgumentException('non-nullable secured_forms cannot be null');
        }
        $this->container['secured_forms'] = $secured_forms;
