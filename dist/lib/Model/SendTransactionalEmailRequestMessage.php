<?php
/**
 * SendTransactionalEmailRequestMessage
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * SendTransactionalEmailRequestMessage Class Doc Comment
 *
 * @category Class
 * @package  StejskyTom\Ecomail
 * @author   OpenAPI Generator team
 ...
 */
class SendTransactionalEmailRequestMessage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Send_transactional_email_request_message';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('amp_html', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['amp_html'];
    }

    /**
     * Sets amp_html
     *
     * @param string|null $amp_html amp_html
     *
     * @return self
     */
    public function setAmpHtml($amp_html)
    {
        if (is_null($amp_html)) {
            throw new \InvalidArgumentException('non-nullable amp_html cannot be null');
        }
        $this->container['amp_html'] = $amp_html;
