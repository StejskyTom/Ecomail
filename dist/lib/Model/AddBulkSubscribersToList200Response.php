...
/**
 * AddBulkSubscribersToList200Response Class Doc Comment
 *
 * @category Class
 * @package  StejskyTom\Ecomail
 * @author   OpenAPI Generator team
 ...
 */
class AddBulkSubscribersToList200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Add_bulk_subscribers_to_list_200_response';
    ...
    {
        $this->setIfExists('inserts', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['inserts'];
    }

    /**
     * Sets inserts
     *
     * @param float|null $inserts inserts
     *
     * @return self
     */
    ...
    {
        if (is_null($inserts)) {
            throw new \InvalidArgumentException('non-nullable inserts cannot be null');
        }
        $this->container['inserts'] = $inserts;
