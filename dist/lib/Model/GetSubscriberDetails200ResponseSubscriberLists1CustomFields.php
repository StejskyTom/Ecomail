<?php
/**
 * GetSubscriberDetails200ResponseSubscriberLists1CustomFields
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetSubscriberDetails200ResponseSubscriberLists1CustomFields Class Doc Comment
 *
 * @category Class
 * @package  StejskyTom\Ecomail
 * @author   OpenAPI Generator team
 ...
 */
class GetSubscriberDetails200ResponseSubscriberLists1CustomFields implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Get_subscriber_details_200_response_subscriber_lists_1_custom_fields';
    ...
    {
        $this->setIfExists('somefield', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['somefield'];
    }

    /**
     * Sets somefield
     *
     * @param string|null $somefield somefield
     *
     * @return self
     */
    public function setSomefield($somefield)
    {
        if (is_null($somefield)) {
            throw new \InvalidArgumentException('non-nullable somefield cannot be null');
        }
        $this->container['somefield'] = $somefield;
