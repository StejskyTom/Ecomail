<?php
/**
 * ShowList200ResponseListFormSettingsColors
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ShowList200ResponseListFormSettingsColors Class Doc Comment
 *
 * @category Class
 * @package  StejskyTom\Ecomail
 * @author   OpenAPI Generator team
 ...
 */
class ShowList200ResponseListFormSettingsColors implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Show_list_200_response_list_form_settings_colors';
    ...
    {
        $this->setIfExists('bg_color', $data ?? [], null);
        $this->setIfExists('holder_color', $data ?? [], null);
        $this->setIfExists('submit_color', $data ?? [], null);
        $this->setIfExists('title_color', $data ?? [], null);
        $this->setIfExists('text_color', $data ?? [], null);
        $this->setIfExists('submit_text_color', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets bg_color
     *
     * @param string|null $bg_color bg_color
     *
     * @return self
     */
    ...
    {
        if (is_null($bg_color)) {
            throw new \InvalidArgumentException('non-nullable bg_color cannot be null');
        }
     ...
     * @return string|null
     */
    public function getHolderColor()
    {
        return $this->container['holder_color'];
    }

    /**
     * Sets holder_color
     *
     * @param string|null $holder_color holder_color
     *
     * @return self
     */
    public function setHolderColor($holder_color)
    {
        if (is_null($holder_color)) {
            throw new \InvalidArgumentException('non-nullable holder_color cannot be null');
        }
        $this->container['holder_color'] = $holder_color;
     ...
     * Sets submit_color
     *
     * @param string|null $submit_color submit_color
     *
     * @return self
     */
     ...
     * Sets title_color
     *
     * @param string|null $title_color title_color
     *
     * @return self
     */
    ...
    /**
     * Gets submit_text_color
     *
     * @return string|null
     */
    public function getSubmitTextColor()
    {
        return $this->container['submit_text_color'];
    }

    /**
     * Sets submit_text_color
     *
     * @param string|null $submit_text_color submit_text_color
     *
     * @return self
     */
    public function setSubmitTextColor($submit_text_color)
    {
        if (is_null($submit_text_color)) {
            throw new \InvalidArgumentException('non-nullable submit_text_color cannot be null');
        }
        $this->container['submit_text_color'] = $submit_text_color;
