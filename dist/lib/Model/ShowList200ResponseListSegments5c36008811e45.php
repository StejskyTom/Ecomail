<?php
/**
 * ShowList200ResponseListSegments5c36008811e45
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ShowList200ResponseListSegments5c36008811e45 Class Doc Comment
 *
 * @category Class
 * @package  StejskyTom\Ecomail
 * @author   OpenAPI Generator team
 ...
 */
class ShowList200ResponseListSegments5c36008811e45 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Show_list_200_response_list_segments_5c36008811e45';
    ...
    */
     ...
     * Sets based_on
     *
     * @param mixed|null $based_on based_on
     *
     * @return self
     */
    ...
    {
        if (is_null($based_on)) {
            array_push($this->openAPINullablesSetToNull, 'based_on');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('based_on', $nullablesSetToNull);
            if ($index !== FALSE) {
