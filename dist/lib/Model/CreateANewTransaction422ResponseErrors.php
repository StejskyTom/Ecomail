<?php
/**
 * CreateANewTransaction422ResponseErrors
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * CreateANewTransaction422ResponseErrors Class Doc Comment
 *
 * @category Class
 * @package  StejskyTom\Ecomail
 * @author   OpenAPI Generator team
 ...
 */
class CreateANewTransaction422ResponseErrors implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Create_a_new_transaction_422_response_errors';
    ...
    {
        $this->setIfExists('transaction_order_id', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param string[]|null $transaction_order_id transaction_order_id
     *
     * @return self
     */
    public function setTransactionOrderId($transaction_order_id)
    {
        if (is_null($transaction_order_id)) {
            throw new \InvalidArgumentException('non-nullable transaction_order_id cannot be null');
        }
