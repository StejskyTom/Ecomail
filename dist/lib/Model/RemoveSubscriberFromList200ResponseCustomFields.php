<?php
/**
 * RemoveSubscriberFromList200ResponseCustomFields
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * RemoveSubscriberFromList200ResponseCustomFields Class Doc Comment
 *
 * @category Class
 * @package  StejskyTom\Ecomail
 * @author   OpenAPI Generator team
 ...
 */
class RemoveSubscriberFromList200ResponseCustomFields implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Remove_subscriber_from_list_200_response_custom_fields';
    ...
    {
        $this->setIfExists('mergetag', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['mergetag'];
    }

    /**
     * Sets mergetag
     *
     * @param string|null $mergetag mergetag
     *
     * @return self
     */
    public function setMergetag($mergetag)
    {
        if (is_null($mergetag)) {
            throw new \InvalidArgumentException('non-nullable mergetag cannot be null');
        }
        $this->container['mergetag'] = $mergetag;
