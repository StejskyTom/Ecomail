<?php
/**
 * CreateBulkTransactionsRequestTransactionDataInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * CreateBulkTransactionsRequestTransactionDataInner Class Doc Comment
 *
 * @category Class
 * @package  StejskyTom\Ecomail
 * @author   OpenAPI Generator team
 ...
 */
class CreateBulkTransactionsRequestTransactionDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Create_bulk_transactions_request_transaction_data_inner';
    ...
    protected static $openAPITypes = [
        'transaction' => '\StejskyTom\Ecomail\Model\CreateBulkTransactionsRequestTransactionDataInnerTransaction',
        'transaction_items' => '\StejskyTom\Ecomail\Model\CreateBulkTransactionsRequestTransactionDataInnerTransactionItemsInner[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('transaction_items', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['transaction_items'] === null) {
            $invalidProperties[] = "'transaction_items' can't be null";
        }
     ...
     * Gets transaction
     *
     * @return \StejskyTom\Ecomail\Model\CreateBulkTransactionsRequestTransactionDataInnerTransaction
     */
     ...
     * Sets transaction
     *
     * @param \StejskyTom\Ecomail\Model\CreateBulkTransactionsRequestTransactionDataInnerTransaction $transaction transaction
     *
     * @return self
     */
     ...
     *
     * @return \StejskyTom\Ecomail\Model\CreateBulkTransactionsRequestTransactionDataInnerTransactionItemsInner[]
     */
     ...
     *
     * @param \StejskyTom\Ecomail\Model\CreateBulkTransactionsRequestTransactionDataInnerTransactionItemsInner[] $transaction_items transaction_items
     *
     * @return self
     */
    public function setTransactionItems($transaction_items)
    {
        if (is_null($transaction_items)) {
            throw new \InvalidArgumentException('non-nullable transaction_items cannot be null');
        }
