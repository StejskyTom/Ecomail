<?php
/**
 * GetCampaignStatsDetail200ResponseSubscribers
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetCampaignStatsDetail200ResponseSubscribers Class Doc Comment
 *
 * @category Class
 * @package  StejskyTom\Ecomail
 * @author   OpenAPI Generator team
 ...
 */
class GetCampaignStatsDetail200ResponseSubscribers implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Get_campaign_stats_detail_200_response_subscribers';
    ...
    protected static $openAPITypes = [
        'foobar_com' => '\StejskyTom\Ecomail\Model\GetCampaignStatsDetail200ResponseSubscribersFooBarCom',
        'foo2bar_com' => '\StejskyTom\Ecomail\Model\GetCampaignStatsDetail200ResponseSubscribersFooBarCom'
    ];
    ...
    protected static $attributeMap = [
        'foobar_com' => 'foo@bar.com',
        'foo2bar_com' => 'foo2@bar.com'
    ];
    ...
    protected static $setters = [
        'foobar_com' => 'setFoobarCom',
        'foo2bar_com' => 'setFoo2barCom'
    ];
    ...
    protected static $getters = [
        'foobar_com' => 'getFoobarCom',
        'foo2bar_com' => 'getFoo2barCom'
    ];
    ...
    {
        $this->setIfExists('foobar_com', $data ?? [], null);
        $this->setIfExists('foo2bar_com', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets foobar_com
     *
     * @return \StejskyTom\Ecomail\Model\GetCampaignStatsDetail200ResponseSubscribersFooBarCom|null
     */
    public function getFoobarCom()
    {
        return $this->container['foobar_com'];
    }

    /**
     * Sets foobar_com
     *
     * @param \StejskyTom\Ecomail\Model\GetCampaignStatsDetail200ResponseSubscribersFooBarCom|null $foobar_com foobar_com
     *
     * @return self
     */
    public function setFoobarCom($foobar_com)
    {
        if (is_null($foobar_com)) {
            throw new \InvalidArgumentException('non-nullable foobar_com cannot be null');
        }
        $this->container['foobar_com'] = $foobar_com;
     ...
     * @return \StejskyTom\Ecomail\Model\GetCampaignStatsDetail200ResponseSubscribersFooBarCom|null
     */
    public function getFoo2barCom()
    {
        return $this->container['foo2bar_com'];
    }

    /**
     * Sets foo2bar_com
     *
     * @param \StejskyTom\Ecomail\Model\GetCampaignStatsDetail200ResponseSubscribersFooBarCom|null $foo2bar_com foo2bar_com
     *
     * @return self
     */
    public function setFoo2barCom($foo2bar_com)
    {
        if (is_null($foo2bar_com)) {
            throw new \InvalidArgumentException('non-nullable foo2bar_com cannot be null');
        }
        $this->container['foo2bar_com'] = $foo2bar_com;
