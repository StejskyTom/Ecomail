...
/**
 * UpdateSubscriber200Response Class Doc Comment
 *
 * @category Class
 * @package  StejskyTom\Ecomail
 * @author   OpenAPI Generator team
 ...
 */
class UpdateSubscriber200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Update_subscriber_200_response';
    ...
    */
     ...
     * Sets bounce_hard
     *
     * @param mixed|null $bounce_hard bounce_hard
     *
     * @return self
     */
    public function setBounceHard($bounce_hard)
    {
        if (is_null($bounce_hard)) {
            array_push($this->openAPINullablesSetToNull, 'bounce_hard');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('bounce_hard', $nullablesSetToNull);
            if ($index !== FALSE) {
