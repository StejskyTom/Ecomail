...
/**
 * AddNewSubscriberToListRequest Class Doc Comment
 *
 * @category Class
 * @package  StejskyTom\Ecomail
 * @author   OpenAPI Generator team
 ...
 */
class AddNewSubscriberToListRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Add_new_subscriber_to_list_request';
    ...
    protected static $openAPITypes = [
        'subscriber_data' => '\StejskyTom\Ecomail\Model\AddNewSubscriberToListRequestSubscriberData',
        'groups' => '\StejskyTom\Ecomail\Model\AddNewSubscriberToListRequestGroups',
    ...
    protected static $setters = [
        'subscriber_data' => 'setSubscriberData',
        'groups' => 'setGroups',
        'trigger_autoresponders' => 'setTriggerAutoresponders',
        'update_existing' => 'setUpdateExisting',
        'resubscribe' => 'setResubscribe'
    ];
    ...
    protected static $getters = [
        'subscriber_data' => 'getSubscriberData',
        'groups' => 'getGroups',
        'trigger_autoresponders' => 'getTriggerAutoresponders',
        'update_existing' => 'getUpdateExisting',
        'resubscribe' => 'getResubscribe'
    ];
    ...
    {
        $this->setIfExists('subscriber_data', $data ?? [], null);
        $this->setIfExists('groups', $data ?? [], null);
        $this->setIfExists('trigger_autoresponders', $data ?? [], null);
        $this->setIfExists('update_existing', $data ?? [], null);
        $this->setIfExists('resubscribe', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets subscriber_data
     *
     * @return \StejskyTom\Ecomail\Model\AddNewSubscriberToListRequestSubscriberData|null
     */
    public function getSubscriberData()
    {
        return $this->container['subscriber_data'];
    }

    /**
     * Sets subscriber_data
     *
     * @param \StejskyTom\Ecomail\Model\AddNewSubscriberToListRequestSubscriberData|null $subscriber_data subscriber_data
     *
     * @return self
     */
    public function setSubscriberData($subscriber_data)
    {
        if (is_null($subscriber_data)) {
            throw new \InvalidArgumentException('non-nullable subscriber_data cannot be null');
        }
        $this->container['subscriber_data'] = $subscriber_data;
     ...
     * Gets groups
     *
     * @return \StejskyTom\Ecomail\Model\AddNewSubscriberToListRequestGroups|null
     */
     ...
     * Sets groups
     *
     * @param \StejskyTom\Ecomail\Model\AddNewSubscriberToListRequestGroups|null $groups groups
     *
     * @return self
     */
    ...
    /**
     * Gets trigger_autoresponders
     *
     * @return bool|null
     */
    public function getTriggerAutoresponders()
    {
        return $this->container['trigger_autoresponders'];
    }

    /**
     * Sets trigger_autoresponders
     *
     * @param bool|null $trigger_autoresponders trigger_autoresponders
     *
     * @return self
     */
    public function setTriggerAutoresponders($trigger_autoresponders)
    {
        if (is_null($trigger_autoresponders)) {
            throw new \InvalidArgumentException('non-nullable trigger_autoresponders cannot be null');
        }
        $this->container['trigger_autoresponders'] = $trigger_autoresponders;
    ...
    {
        return $this->container['resubscribe'];
    }

    /**
     * Sets resubscribe
     *
     * @param bool|null $resubscribe resubscribe
     *
     * @return self
     */
    public function setResubscribe($resubscribe)
    {
        if (is_null($resubscribe)) {
            throw new \InvalidArgumentException('non-nullable resubscribe cannot be null');
        }
        $this->container['resubscribe'] = $resubscribe;
