...
class SearchApi
{
     ...
     * @param  \StejskyTom\Ecomail\Model\FindContactRequest $find_contact_request find_contact_request (optional)
     ...
     * @return void
     */
    public function findContact($key = null, $find_contact_request = null, string $contentType = self::contentTypes['findContact'][0])
    {
        $this->findContactWithHttpInfo($key, $find_contact_request, $contentType);
    }
     ...
     *
     * @param  string $key e.g. API_KEY (optional)
     * @param  \StejskyTom\Ecomail\Model\FindContactRequest $find_contact_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['findContact'] to see the possible values for this operation
     *
     * @throws \StejskyTom\Ecomail\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function findContactWithHttpInfo($key = null, $find_contact_request = null, string $contentType = self::contentTypes['findContact'][0])
    {
        $request = $this->findContactRequest($key, $find_contact_request, $contentType);
     ...
     */
    public function findContactAsync($key = null, $find_contact_request = null, string $contentType = self::contentTypes['findContact'][0])
    {
        return $this->findContactAsyncWithHttpInfo($key, $find_contact_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function findContactAsyncWithHttpInfo($key = null, $find_contact_request = null, string $contentType = self::contentTypes['findContact'][0])
    {
        $returnType = '';
        $request = $this->findContactRequest($key, $find_contact_request, $contentType);
     ...
     */
    public function findContactRequest($key = null, $find_contact_request = null, string $contentType = self::contentTypes['findContact'][0])
    {
        ...
        // for model (json/xml)
        if (isset($find_contact_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($find_contact_request));
            } else {
                $httpBody = $find_contact_request;
            }
